...
//   mock-telegram-purge 02:40 daily — intercepted messages older than 30 days (D-66)
...
import { mockTelegramPurge } from './mock-telegram-purge.js';
...
export const JOBS: JobDefinition[] = [
  ...
  { name: 'mock-telegram-purge', schedule: 'daily 02:40 Asia/Riyadh', periodKey: dailyAt('mock-telegram-purge', '02:40'), run: mockTelegramPurge, maxAgeMinutes: 26 * 60 },
