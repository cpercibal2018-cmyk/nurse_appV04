...
| D-48 (2026-09-24) | **SMS through the hospital SMS gateway** | Break-glass alert to the CEO and IT Director (spec §3.6); optional reminders. Hospital IT supplies the gateway API details. To be built |
