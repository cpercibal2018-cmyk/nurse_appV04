...
| D-47 (2026-09-24) | **E-mail through the hospital SMTP relay** | Reminders, the break-glass alert (spec §3.6), password reset and invitations. Hospital IT supplies host, port and a service account. To be built |
